    ...
    public override int PerformEffect(GameData data)
    {
        ...
        if (go.TryGetComponent(out target))
        {
            ...
            switch (target.GetFieldLocation())
            {
                ...
                case 1:
                    target.SetCardHealth(target.GetCardHealth() - 5);
                    buildingsOnField[2].SetCardHealth(buildingsOnField[2].GetCardHealth() - 3);
                    buildingsOnField[4].SetCardHealth(buildingsOnField[4].GetCardHealth() - 3);
                    break;
                //Attack location 2 and 1/5
                case 2:
                    target.SetCardHealth(target.GetCardHealth() - 5);
                    buildingsOnField[1].SetCardHealth(buildingsOnField[1].GetCardHealth() - 3);
                    buildingsOnField[5].SetCardHealth(buildingsOnField[5].GetCardHealth() - 3);
                    break;
                ...
                case 4:
                    target.SetCardHealth(target.GetCardHealth() - 5);
                    buildingsOnField[1].SetCardHealth(buildingsOnField[1].GetCardHealth() - 3);
                    buildingsOnField[3].SetCardHealth(buildingsOnField[3].GetCardHealth() - 3);
                    buildingsOnField[5].SetCardHealth(buildingsOnField[5].GetCardHealth() - 3);
                    break;
